          ...
          {state.error ? (
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
              ...
              <div className="xl:col-span-4 space-y-6">
                ...
                {state.weather && (
                  <StatsGrid
                    ...
                    airQuality={state.airQuality || undefined}
                  />
                )}
              </div>

              {/* Center Column - Forecast */}
              <div className="xl:col-span-5">
                {state.hourlyForecast.length > 0 && (
                  <ForecastList
                    hourlyData={state.hourlyForecast}
                    dailyData={state.dailyForecast}
                  />
                )}
              </div>
              ...
              <div className="xl:col-span-3 space-y-6">
                {state.weather && (
                  <WeatherCard data={state.weather} compact />
                )}
